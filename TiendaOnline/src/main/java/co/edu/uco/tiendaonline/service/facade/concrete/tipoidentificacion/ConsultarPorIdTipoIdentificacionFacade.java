...
import co.edu.uco.tiendaonline.service.businesslogic.concrete.tipoidentificacion.ConsultarPorIdTipoIdentificacionUseCase;
...
public final class ConsultarPorIdTipoIdentificacionFacade implements Facade<TipoIdentificacionDTO>{
	...
	public final void execute(final TipoIdentificacionDTO dto) {
			...
			try {
				...
				var useCase = new ConsultarPorIdTipoIdentificacionUseCase(daoFactory);
